...
public class Dictionary extends TreeMap<String,String>{
  ...
  public Map<String,String> findByWord(String word) {
    ...
    //2)일치하는 단어가 없을경우. 즉, 범위검색
    char firstLetter = wordToLowerCase.charAt(0);  //'s'
    char nextLetter = (char)(wordToLowerCase.charAt(0) + 1); //'t'

    map = subMap(wordToLowerCase, true, String.valueOf(nextLetter), false);
